...
-------------------------------
Purpose of Openweather API is to provide temperature and timezone informaiton based on the city and country. 
API uses'POST' request to communicate and HTTP [response codes] to indicate status and errors in standard JSON format.
